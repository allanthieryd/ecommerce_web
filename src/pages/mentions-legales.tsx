...
const MENTIONS_LEGALES: React.FC = () => {
  return (
    <>
      <main>
        <h1 className="text-4xl font-bold mb-6 text-center pt-20">
          Mentions Légales
        </h1>
        <div className="container mx-auto px-8 py-6">
          <div className="text-justify py-4">
            ...
            <p className="pb-6">
              Contenu : ensemble des éléments constituants l’information
          ...
          <div className="text-justify py-4">
            ...
            <p>
              Propriétaire : sas cyna-it capital social de 1000 euros‚ numéro de
              tva : fr20913711032 : 10 rue de Penthièvre 75008 paris
            </p>
            <p>
              Responsable publication : elbaz alexandre :
              <a
                className="hover:text-[#02ff1e]"
          ...
          <div className="text-justify py-4">
            ...
            <p className="pb-6">
              ...
              <a className="hover:text-[#02ff1e]" href="https://www.cyna-it.f">
                www.cyna-it.fr
              </a>
            ...
            <p className="pb-6">
              Dès que{" "}
              <a
                className="hover:text-[#02ff1e]  ml-2 mr-2"
          ...
          <div className="text-justify py-4">
            ...
            <p className="pb-6">
              ...
              partenaire spécialiste d’analyses web susceptible de se trouver
              (et donc de stocker les informations correspondantes, y compris
